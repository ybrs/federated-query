...
impl EventStore {
    ...
    pub fn create_dataset(
        ...
        Ok(Self::report(&outcome, shards, started))
    }
    ...
    /// against the pinned code counts), and the per-shard file lists.
    pub fn dataset(&self, name: &str) -> Result<Dataset, EventError> {
