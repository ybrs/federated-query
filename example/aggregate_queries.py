...
def main():
    ...
    print("  [OK] COUNT, SUM, AVG, MIN, MAX aggregate functions")
    print("  [OK] GROUP BY with single or multiple columns")
    print("  [OK] Aggregations without GROUP BY (global aggregates)")
    print("  [OK] Multiple aggregate functions in single query")
    print("  [OK] Hash-based aggregation for efficient execution")
    print("  [OK] Federated JOIN + aggregation (cross-database)")
    print("  [OK] HAVING clause for filtering aggregated results")
    print()
